...
def show_help():
    ...
    print("💼 JOB LISTING COMMANDS:")
    print("  jobs list                - List job listings with automatic scraping")
    print("    Options:")
    print("      --page <n>           - Page number (default: 1)")
    print("      --per-page <n>       - Jobs per page")
    print("      --sort-by <field>    - Sort by field (scraped_at, title, company)")
    print("      --sort-order <order> - Sort order (asc, desc)")
    print("      --company <name>     - Filter by company name")
    print("      --location <loc>     - Filter by location")
    print("      --remote-type <type> - Filter by remote type (remote, onsite, hybrid)")
    print("      --experience-level <level> - Filter by experience level")
    print("      --source-site <site> - Filter by source site")
    print("      --interactive        - Interactive browsing mode")
    print("      --no-auto-scrape     - Disable automatic scraping")
    print("      --keywords <list>    - Keywords for auto-scraping (comma-separated)")
    print("      --scrape-location <loc> - Location for auto-scraping")
    print()
    print("  jobs search <term>       - Search jobs with automatic scraping")
    print("    Arguments:")
    print("      <term>               - Search term for title, company, or description")
    print("    Options:")
    print("      --page <n>           - Page number (default: 1)")
    print("      --per-page <n>       - Jobs per page")
    print("      --sort-by <field>    - Sort by field")
    print("      --sort-order <order> - Sort order (asc, desc)")
    print("      --interactive        - Interactive search results")
    print("      --no-auto-scrape     - Disable automatic scraping")
    print("      --scrape-location <loc> - Location for auto-scraping")
    print()
    print("  jobs match <resume_id>   - Find matching jobs for a resume")
    print("    Arguments:")
    print("      <resume_id>          - Resume ID (integer)")
    print("    Options:")
    print("      --page <n>           - Page number (default: 1)")
    print("      --per-page <n>       - Jobs per page")
    print("      --min-compatibility <score> - Minimum compatibility score (0.0-1.0)")
    print("      --interactive        - Interactive job matching browser")
    print("      --no-auto-scrape     - Disable automatic scraping")
    print("      --keywords <list>    - Keywords for auto-scraping (comma-separated)")
    print("      --scrape-location <loc> - Location for auto-scraping")
    print()
    print("  jobs show <job_id>       - Show detailed job information")
    print("    Arguments:")
    print("      <job_id>             - Job ID (integer)")
    print("    Options:")
    print("      --resume-id <id>     - Show compatibility with specific resume")
    print()
    print("  jobs scrape <keywords>   - Manually scrape job listings")
    print("    Arguments:")
    print("      <keywords>           - One or more keywords to search for")
    print("    Options:")
    print("      --location <loc>     - Location to search in")
    print("      --max-pages <n>      - Maximum pages to scrape per site (default: 3)")
    print("      --force              - Force scraping even if data is fresh")
    print("      --sites <list>       - Comma-separated list of sites to scrape")
    print()
    print("  jobs scrape-status       - Show scraping status and data freshness")
    print("  jobs stats               - Show job listing statistics")
    print()
    print("🎯 RESUME ADAPTATION COMMANDS:")
    print("  resume adapt <resume_id> <job_id> - Adapt resume for specific job")
    print()
    ...
    print()
    print("  # Job listing and scraping")
    print("  python scripts/run_app.py jobs list")
    print("  python scripts/run_app.py jobs list --interactive --keywords \"python,django\"")
    print("  python scripts/run_app.py jobs search \"software engineer\" --location \"San Francisco\"")
    print("  python scripts/run_app.py jobs match 1 --min-compatibility 0.7")
    print("  python scripts/run_app.py jobs scrape python django --location \"Remote\" --max-pages 5")
    print("  python scripts/run_app.py jobs scrape-status")
    print("  python scripts/run_app.py jobs stats")
    print()
...
def main():
    ...
    if command == "help":
        ...
        # Pass all remaining arguments directly to the CLI for job commands
        return run_app_cli("jobs", *remaining_args).returncode
        ...
        print()
        print("JOB SUBCOMMANDS:")
        print("  list                     List job listings with auto-scraping")
        print("  search <term>            Search jobs with auto-scraping")
        print("  match <resume_id>        Find matching jobs for resume")
        print("  show <job_id>            Show job details")
        print("  scrape <keywords>        Manually scrape job listings")
        print("  scrape-status            Show scraping status")
        ...
        print("  python scripts/run_app.py jobs list --interactive")
        print("  python scripts/run_app.py jobs scrape python django --location Remote")
        print()

...
- [ ] 1. Remove fallback logic from AIMatchingService
...
- [ ] 2. Simplify KeywordExtractionResult dataclass
...
- [ ] 3. Update service info and error handling
...
- [ ] 4. Remove Ollama mocks from AI matching service tests
...
- [ ] 5. Remove Ollama mocks from resume AI integration tests
...
- [ ] 6. Add Ollama availability checks to test setup
...
- [ ] 7. Update task documentation to remove fallback references
